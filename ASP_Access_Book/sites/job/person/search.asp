    ...
    <td width="139" valign="top" bgcolor="#53BEB0" height="176"> 　 
      ...
      <td width="480" height="284" valign="top">
           <% set rs=server.createobject("adodb.recordset") 
			  ...
			  sql="select * from company where job  like '%"&key&"%' order by id desc" 
        ...
        <div align="left">
         ...
         以下是[<font color="red"><%=page_start%>～<%=page_end%></font>]条</font></td>          
          <tr> 
		  <td width="461" height="6" colspan="5" valign="bottom">
          ...
          <tr>
      <td height="3" valign="top" colspan="5" bgcolor="#000000" width="461">
      </td>
          </tr>
		  <tr>
