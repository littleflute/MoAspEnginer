...
<table border="0" width="100%" cellspacing="0" cellpadding="5">
                  <tr> 
                    <td width="19%" align="right" bgcolor="#F2F2F2">所订产品：</td>
                    <td width="81%"><%=rst("p_name")%></td>
                  </tr>
                  <tr> 
                    <td width="19%" align="right" bgcolor="#F2F2F2">产品型号：</td>
                    <td width="81%"><%=rst("p_type")%></td>
                  </tr>
                  <tr> 
                    <td width="19%" align="right" bgcolor="#F2F2F2">产品数量：</td>
                    <td width="81%"><%=rst("p_count")%></td>
                  </tr>
                  <tr> 
                    <td width="19%" align="right" bgcolor="#F2F2F2">联系人：</td>
                    <td width="81%"><%=rst("p_connect")%></td>
                  </tr>
                  <tr> 
                    <td width="19%" align="right" bgcolor="#F2F2F2">联系电话：</td>
                    <td width="81%"><%=rst("p_phone")%></td>
                  </tr>
                  <tr> 
                    <td width="19%" align="right" bgcolor="#F2F2F2">备注：</td>
                    <td width="81%"><%=rst("p_text")%></td>
                  </tr>
                  <tr> 
                    <td width="19%" align="right" bgcolor="#F2F2F2">提交时间：</td>
                    <td width="81%"><%=rst("time")%></td>
                  </tr>
                  <tr> 
                    <td align="right" bgcolor="#F2F2F2" colspan="2"><a href="del_order.asp?id=<%=rst("id")%>">删除此记录</a></td>
                  </tr>
                </table>
</td>
</tr>           <%		 		rst.movenext
