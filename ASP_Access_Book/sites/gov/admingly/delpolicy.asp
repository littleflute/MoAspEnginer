...
<%  dim filename,i
  ...
  sql="select pyimg from policy where id in("&id&")"
    set rs=conn.execute(sql)
	      filename=rs.getrows
  sql = "DELETE FROM policy WHERE id In (" & id & ")"
  Conn.Execute(sql)
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  ...
  <tr>
    <td height="20">
<div align="center"><a href="admin_policy.asp">【返回】</a><a href="adminbody.asp">【继续其它操作】</a></div></td>
  </tr>
</table>
