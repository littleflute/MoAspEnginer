...
<div id="layer" style="width:765px; height:531px; position:absolute; left:7px; top:122px; z-index:0; visibility:visible;"> 
  <!------------------------------------------------------------------------------------------------------------------------------> 
  <!---------------------------------------------------------------------------------------------> 
    ...
    <td width="712" height="216" valign="top" bgcolor="#fff4cf" style="border-right-style: solid; border-right-width: 1; border-bottom-style: solid; border-bottom-width: 1" bordercolor="#F4F4F4">
      ...
      <table border="0" width="730" height="15" cellspacing="0" cellpadding="2">
        ...
        <tr>
          ...
          <td width="678" height="6" colspan="5"><b><%=rs_lar("name")%><font color="#1FC41F">个人档案</b></font><p></td>
                        <td></td>
        </tr>
        <tr>
...
<tr>
          ...
          <td width="299" height="212" valign="top"> <!--------------------------------------------------------------------------------------------->
            <table border="0" width="100%" cellspacing="0" cellpadding="0" height="237">
              ...
              <tr>
                <td width="100%" height="8"><font color="#008000">姓名:&nbsp;<%=rs_lar("name")%></font></td>
              </tr>
              <tr>
                <td width="100%" height="14"><font color="#008000">性别:&nbsp;<%=rs_lar("sex")%></font></td>
              </tr>
              <tr>
                <td width="100%" height="14"><font color="#008000">生日:&nbsp;<%=formatdatetime(rs_lar("britherday"),vblongdate)%></font></td>
              </tr>
              <tr>
                <td width="100%" height="14"><font color="#008000">来自:&nbsp;<%=rs_lar("home")%></font></td>
              </tr>
              <tr>
                <td width="100%" height="14"><font color="#008000">职业:&nbsp;<%=rs_lar("job")%></font></td>
              </tr>
              <tr>
                <td width="100%" height="14"><font color="#008000">单位:&nbsp;<%=rs_lar("company")%></font></td>
              </tr>
              <tr>
                <td width="100%" height="14"><font color="#008000">邮编:&nbsp;<%=rs_lar("postcalcode")%></font></td>
              </tr>
              <tr>
                <td width="100%" height="14"><font color="#008000">电话:&nbsp;<%=rs_lar("tel")%></font></td>
              </tr>
              <tr>
          ...
          <td width="310" height="212" valign="top"> <!--------------------------------------------------------------------------------------------->
            <table border="0" width="100%" height="29" cellspacing="0" cellpadding="0">
              <tr>
                <td width="270" height="3" style="border-bottom-style: solid" bordercolor="#000000"><font color="#FF9900"><b>个人爱好</b></font></td>
              </tr>
              <tr>
                <td width="268" height="5">&nbsp;</td>
              </tr>
              <tr>
                <td width="268" height="8"><font color="#008000">喜欢的运动:&nbsp;<%=rs_lar("sport")%></font></td>
              </tr>
              <tr>
                <td width="268" height="12"><font color="#008000">喜欢的书籍:&nbsp;<%=rs_lar("book")%></font></td>
              </tr>
              <tr>
                <td width="268" height="12"><font color="#008000">喜欢的音乐:&nbsp;<%=rs_lar("music")%></font></td>
              </tr>
              <tr>
                <td width="268" height="12"><font color="#008000">喜欢的名人:&nbsp;<%=rs_lar("people")%></font></td>
              </tr>
              <tr>
                <td width="268" height="12"><font color="#008000">其它爱好:&nbsp;&nbsp;&nbsp;<%=rs_lar("interest")%></font></td>
              </tr>
              <tr>
                <td width="268" height="9"><font color="#008000">人生格言:&nbsp;&nbsp;&nbsp;<%=rs_lar("adage")%></font></td>
              </tr>
              <tr>
                <td width="268" height="8"><font color="#008000">性格自述:&nbsp;&nbsp;&nbsp;<%=rs_lar("character")%></font></td>
              </tr>
              <tr>
              ...
              <tr>
                <td width="270" height="8" style="border-bottom-style: solid" bordercolor="#000000"><b><font color="#FF9900">网上行踪&nbsp;</font></b></td>
              </tr>
              <tr>
                <td width="268" height="2">&nbsp;</td>
              </tr>
              <tr>
                <td width="268" height="6"><font color="#008000">网名: &nbsp;<b><%=rs_lar("netname")%></B></font></td>
              </tr>
              <tr>
                <td width="268" height="4"><font color="#008000">主页: &nbsp;<a href="<%=rs_lar("homepage")%>" target="_blank"><%=rs_lar("homepage")%></font></td>
              </tr>
              <tr>
                <td width="268" height="6"><font color="#008000">Email: &nbsp;<font color="ff0000"><a href="mailto:<%=rs_lar("email")%>"><%=rs_lar("email")%></font></font></td>
              </tr>
              <tr>
                <td width="268" height="4"><font color="#008000">网络寻呼机: &nbsp;<%=rs_lar("netcall")%></font></td>
              </tr>
              <tr>
                <td width="268" height="4"><font color="#008000">常去的聊天室:&nbsp; <a href="<%=rs_lar("chatroom")%>" ><%=rs_lar("chatroom")%></font></td>
              </tr>
              <tr>
                <td width="268" height="5"></td>
              </tr>
...
<map name="FPMap2"></map>
<map name="Map"> 
  <area shape="rect" coords="230,94,272,112" href="default.asp">
  <area shape="rect" coords="295,92,356,112" href="your.asp">
  <area shape="rect" coords="381,93,445,110" href="list.asp">
  <area shape="rect" coords="467,92,536,112" href="register.asp">
  <area shape="rect" coords="556,93,616,112" href="sendphoto.asp">
  <area shape="rect" coords="639,92,706,112" href="pics.asp">
</map>
</body>
