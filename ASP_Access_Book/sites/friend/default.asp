...
border=0>
      ...
      <table border="1" width="160" cellspacing="0" cellpadding="0" bordercolorlight="#330000" bordercolordark="#FFFFFF" bordercolor="#330000">
        ...
        <tr bgcolor="#DDF9FF"> 
          <td width="90" height="20" align="center"><%=records%><font color="#FF0000">　</font></td>
          <td width="67" height="20" align="center" bgcolor="#DDF9FF"><%=today_records%><font color="#FF0000">　</font></td>
        </tr>
      </table>
      <br>
      <table border="1" width="160" bordercolor="#CC0000" cellspacing="0" cellpadding="0" bordercolorlight="#990000" bordercolordark="#FFFFFF">
        <tr bgcolor="#FFCCFF"> 
          <td width="155" height="17" align="center" bgcolor="#AEC9E3"> 网 际 寻 
            友</td>
        </tr>
        <tr bgcolor="#FFEBE1"> 
          <td width="155" bgcolor="#AEC9E3"> 
            <form action="searchout.asp" method="POST">
              <table border="0" width="100%" cellspacing="0" cellpadding="0" bordercolor="#A5EF00">
                ...
                <tr valign="bottom" bgcolor="#DDF9FF"> 
        ...
        <tr align="center"> 
          <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="25%"><img src="image/1%5B3%5D.gif" width="12" height="12"> 本周最佳人气<img src="image/1%5B3%5D.gif" width="12" height="12"></td>
                <td width="75%"><hr noshade size="1">
                </td>
              </tr>
            </table>
            <table width="419" height="163" border="0" cellpadding="0" cellspacing="0" background="bihaibg.jpg">
              <tr> 
        ...
        <tr align="center"> 
          <td width="100%" valign="top"> 
            ...
            <table width="98%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td> 
                  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" background="bihaibg.jpg">
                    <tr> 
                    ...
                    <tr> 
                      <td align="center" width="30%" rowspan="8"><a href='read.asp?user_id=143'><font color="black"><img border="1" src='display.asp?id=10' width="90" height="120"></font></a><a href="read.asp?user_id=143" target="_blank"><br>
                        详细资料--&gt; </a></td>
    ...
    <!--2td--> 
    <td width="151" bgcolor="white" valign="top" align="center"><table border="0" width="98%" cellpadding="0" cellspacing="0" bordercolorlight="#000000" bordercolordark="#FFFFFF">
      <tr valign="top">
        <td></td>
        <br>
      </tr>
        ...
        <tr> 
          <td width="151"> 
            <table
              ...
              <tr bgcolor="#067B0F"> 
                <td width="153" height="15" bgcolor="#AEC9E3"> 
                  <p
                                                 align="center"><font face="Wingdings" color="#000000">1</font><font face="Wingdings" color="#FFFF33"> 
                    </font><font color="#000000">人气排行榜 </font> </td>
              </tr>
              <tr> 
                <td width="153" height="33" bgcolor="white"> 
                  <table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#DDF9FF">
                    <tr bgcolor="#DDF9FF"> 
                      <td width="28%" align="center" ><font color="#000000">性别</font></td>
                      <td width="46%" height="16" align="center"> 
                        <p align="left"><font color="#000000">网名</font></p>
                      </td>
                      <td width="26%" height="16" align="center"><font color="#FFFFFF">人气</font> 
                      </td>
                    </tr>
                    <%i=1%> <%do while not(rs_lar.eof) and i<11%> 
                    <tr bgcolor="#DDF9FF"> 
                      <td width="28%" height="18" align="center" ><%=rs_lar("sex")%></td>
                      <td width="46%" height="18" align="center"> 
                        <p align="left"><a href="read.asp?user_id=<%=rs_lar("user_id")%>"><%=rs_lar("netname")%></a> 
                      </td>
                      <td width="26%" height="18" align="center"><%=rs_lar("renqi")%> 
                      </td>
                    </tr>
        ...
        <tr> 
          <td width="151"> 
            <table
              ...
              <tr bgcolor="#067B0F"> 
                <td height="15" bgcolor="#AEC9E3"> 
                  <p
                                                             align="center"><font face="Wingdings" color="#FFFF66">1 
                    </font><font color="#FFFF66">最新加入网友</font> </td>
              </tr>
              <tr> 
                <td height="23" bgcolor="white">
                  <table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#DDF9FF">
                    ...
                    <tr bgcolor="#DDF9FF" class="unnamed1"> 
                      <td width="26%" height="18" align="center"><%=rs_new("sex")%></td>
                      <td width="53%" align="left" height="18"> 
                        <p align="left"><a href="read.asp?user_id=<%=rs_new("user_id")%>"><%=rs_new("netname")%></a> 
                      </td>
                      <td width="21%" height="18" align="center"><%=rs_new("renqi")%></td>
                    </tr>
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><img src="a.jpg" width="774" height="120"></td>
  </tr>
</table>
<%
dim p
...
<table width="772" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="white" bordercolorlight="white" bordercolordark="white" bgcolor="#FFFFFF">
  <tr>
    <td colspan="3" bgcolor="#ffffff" valign="top" align="center" bordercolor="#660000"><table border="1" cellspacing="7" cellpadding="7" bordercolorlight="#990000" bordercolordark="#990000" bordercolor="#660000" width="100%" bgcolor="#FFF7F7" >
      <%Set connpic = Server.CreateObject("ADODB.Connection")    
          DBPath = Server.MapPath("data/picture.mdb")    
          connpic.Open "driver={Microsoft Access Driver (*.mdb)};dbq=" & DBPath 
	sql = "select top 4 id,user_id from pic"
	Set rs_lar = Server.CreateObject("ADODB.Recordset")
...
'分页设置
	...
	for i = 1 to 4 '一共显示？行%>
      <tr align="center">
        <%for j = 1 to 6 '一行显示女会员个数
        if not rs_lar.eof then  %>
        <td><a href="display.asp?id=<%=rs_lar("id")%>" target="_blank"><img border="1" src='display.asp?id=<%=rs_lar("id")%>' width="90" height="120" alt="点击放大！"  onClick="return js_openpage(this.href);"></a> <br>
              <a href="read.asp?user_id=<%=rs_lar("user_id")%>" target="_blank">详细资料</a>
          <%if session("admin_pass")="ok" then%>
          <a href="deluser.asp?user_id=<%=rs_lar("user_id")%>">删</a> <a href="delpic.asp?id=<%=rs_lar("id")%>">删照</a>
          <%end if%>
        </td>
        <%rs_lar.movenext
         end if
  ...
  <tr>
    <td colspan="5" align="center" height="30">[<a href="adminlogin.asp">管理入口</a>]</td>
    <!------------------------------------------------------------------------------------------------------------------------->
    <!------------------------------------------------------------------------------------------------------------------------->
  </tr>
</table>
