        ...
        <table border="0" cellpadding="0" cellspacing="0" width="317" bordercolor="#3399FF"  height="262">
          ...
          <tr> 
            ...
            <td width="211" bgcolor="#FFFFFF" height="23">&nbsp; 
              <input type="password" maxLength="16" class="input1" size="25" name="password2">
            </td>
          </tr>
          <tr> 
          ...
          <tr align="center"> 
            <td colspan="2" height="19" width="315" bgcolor="#FFFFFF"> 
              <input value="注 册" name="Submit" type="submit" class="input2" style="height: 16; width:44">
              <input type="reset" value="重 写" name="Submit2" class="input2" style="height: 16 width:44">
            </td>
          </tr>
          <tr align="center"> 
