...
%>      <tr>
  ...
  <tr>
    <td width="363" colspan="3" height="21">
    </td>
  </tr>
  <tr>
    <td width="363" colspan="3" height="36"><form name="DONE" action="Doit.asp" method="POST"><input name="OP" type="hidden"><input name="NumBer" type="hidden">
      <table border="1" cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#FFFFFF" bordercolordark="#808080" height="31">
        <tr>
          <td width="71%" height="19">&nbsp;<font size="2">1、如果订单不合法，请将其作废。</font></td>
          <td width="29%" bgcolor="#C0C0C0" height="19">—〉<font size="2" color="blue"><a href style="CURSOR:hand" onClick="DONE.OP.value=1; DONE.NumBer.value='<%=request("Num")%>'; DONE.submit()">作废</a></font></td>
        </tr>
        <tr>
          <td width="71%" height="8"><font size="2">&nbsp;2、如果已将定购物品寄出，请选此项。</font></td>
          <td width="29%" bgcolor="#C0C0C0" height="8">—〉<font size="2" color="blue"><a href style="CURSOR:hand" onClick="DONE.OP.value=2; DONE.NumBer.value='<%=request("Num")%> '; DONE.submit()">完成</a></font></td>
        </tr>
        <tr>
          <td width="71%" height="8"><font size="2">&nbsp;3、如果暂时不做处理，请选择关闭。</font></td>
          <td width="29%" bgcolor="#C0C0C0" height="8">—〉<font size="2" color="blue"><a href style="CURSOR:hand" onClick="window.close()">关闭</a></font></td>
        </tr>
      </table></form>
    </td>
  </tr>
