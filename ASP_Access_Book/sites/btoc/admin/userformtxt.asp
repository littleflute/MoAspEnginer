...
<table border="0" cellpadding="0" cellspacing="0" width="353" height="236">
  ...
  <tr>
    <td width="233" height="26">&nbsp;<font size="3"  color="#000080">订单号码:&nbsp;<%=request("Num")%></font></td>
  </tr>
  <tr>
    <td width="233" height="21">&nbsp;<font size="3"  color="#000080">用户帐号:&nbsp;<%=request("Nam")%></font></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="363" colspan="3" height="9">
      <table border="1" cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#FFFFFF" bordercolordark="#808080">
        <tr>
          <td width="197" bgcolor="#C0C0C0" align="center"><font  size="3">商品名称</font></td>
          <td width="83" bgcolor="#C0C0C0" align="center"><font  size="3">价格</font></td>
          <td width="71" bgcolor="#C0C0C0" align="center"><font  size="3">数量</font></td>
        </tr>
<%
	dim TotalMoney
	Do while Not rs.EOF
...
%>      <tr>
			<td colspan="3">
              <p align="right"><font >订单总价为:<font color="#FF0000"><%=FormatNumber(TotalMoney,2)%></font><font color="#000000">元</font></font>
            </td>
		</tr>
		</table>
    </td>
  ...
  <tr>
    <td width="363" colspan="3" height="36">
</form>
    </td>
  </tr>
</table>
