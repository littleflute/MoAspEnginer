<%
	...
	SQL = "Select * from 订单管理 where 完成时间<>'无' and 标记<>'废' order by 订单号"
      ...
      <td width="100%" colspan="5">
        ...
        <table border="1" cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#FFFFFF" bordercolordark="#808080">
          <tr>
            ...
            <td width="20%" align="center" bgcolor="#FFFF66"><font face="宋体" size="2"><b>完成时间</b></font></td>
          </tr>
<%
	Do while Not rs.EOF
%>
          <tr>
            ...
            <td width="20%" align="center" bgcolor="#FFCCFF"><font face="宋体" size="2"><%=rs.fields("完成时间")%></font></td>
          </tr>
<%
	rs.Movenext
	loop
