...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td height="20" align="center" background="pic/h3.gif"><strong><font color="#FFFFFF">修改帖子</font></strong></td>
  </tr>
</table>
<% 
boardid=Trim(Request.QueryString("boardid"))
sql_sel = "select * from news where bbs_id="&request("bbs_id")
set rs_sel=db.execute(sql_sel)
%>
<table border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#e3f1d1" bordercolorlight="#C0C0C0" bordercolordark="#FFFFFF" width=760>
  <form method="post" action="" name="myform"  id="myform" onSubmit="return checkForm()">
    <tr> 
      ...
      <td width="87%"><input name="title" type="text" value="<%= rs_sel("title") %>" size="70">
        ** </td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td class="p9">内容：</td>
      <td><textarea name="body" rows="15" cols="70" wrap="soft"><%=(rs_sel("body"))%></textarea> 
        ...
        <input name="bbs_id" type="hidden" id="bbs_id" value="<%=request("bbs_id")%>"></td>
    </tr>
    <tr> 
      <td></td>
...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <%
	if request("title")<>"" and request("user_name")<>"" then
		...
		bbs_id = request.form("bbs_id") 
		boardid=request.form("boardid")  
			'以下将文章保存到数据库
		dim sql,svalues
     
		sql="select * from news where bbs_id="&bbs_id
