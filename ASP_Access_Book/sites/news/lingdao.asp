    ...
    <table width="780" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="609" valign="top"><table width="580" border="0" align="center" cellpadding="5" cellspacing="5">
            ...
            <%
            set rs=conn.execute("select articleid,title,picurl from article where classid=7 order by addtime desc")
                  i=0
                  do while not rs.eof
                      if i mod 4=0 then%>
                            <tr>
              ...
              <td><table width="98%"  border="0" cellspacing="4" cellpadding="4">
                  <tr>
                    <td align="center" class="txt1"><a href="renwu2.asp?id=<%=rs(0)%>"><img src="<%if trim(rs(2))<>"" then response.write rs(2) else response.write "images/nopicture.gif" end if%>" width="80" height="101" border="0"></a> </td>
                  </tr>
                  <tr>
                    <td align="center"><a href="renwu2.asp?id=<%=rs(0)%>" class="list5"><%=rs(1)%></a></td>
                  </tr>
              </table></td>
              <%i=i+1
			...
			<table width="560"  border="0" align="center" cellpadding="3" cellspacing="3" class="txt1" id="table2">
              <td><table width="100%"  border="0" cellpadding="0" cellspacing="3" class="txt1">
                <%const MaxPerPage=10
                            ...
                            sql="select articleid,title,addtime from article where classid=19"
                            ...
                            if currentPage=1 then
                              showContent
                              showpage totalput,MaxPerPage,"lingdao.asp?"
                            else
                              if (currentPage-1)*MaxPerPage<totalPut then
