...
<%classtype=cint(request("classtype"))%><input type="hidden" name="classtype" value=<%=classtype%>>
<%if classtype=1 then%>
<table class="border" cellspacing="0" width="95%" border="0" cellpadding="4" cellspacing="0" align=center>
	...
	<table border="0" cellspacing="0" width="100%" style="border-collapse: collapse" bordercolor="#111111" cellpadding="0" height="361">
       ...
       <tr>
          ...
          <td  height="58">
          <iframe name="ad" frameborder=0 width=100% height=20 scrolling=no src=../saveannounce_upload.asp></iframe> <BR><input type="text" name="piccontent" size="40"
...
编辑器</FONT></A>』 
        ...
        <tr>
         ...
         <tr>
          ...
          class="smallinput" maxlength="100" value="<%=now()%>"></td>
         </tr>
        <tr>
          <td width="99" align="right" height="28"><b>支持HTML：</b></td>
          <td  height="28" width="608"><input type=checkbox name="htmlable" value="yes"> 选择后文章全部支持HTML语法，UBB语法将没有任何作用</td>
        </tr>
      </table>
      </td>
    </tr>
  ...
  name="cmdcancel" class="but">&nbsp; <input type=button value='UBB预览' name=Button onclick=gopreview() class="but">&nbsp; <input type=button value='HTML预览' name=Button onclick=gopreview2() class="but"></p>
  </center></div>
 <%end if
if classtype=2 then%>
<table class="border" cellspacing="0" width="95%" border="0" cellpadding="4" cellspacing="0" align=center>
       ...
       <tr>
        ...
        <tr>
         ...
         <tr>
          ...
          class="smallinput" maxlength="100" value="<%=now()%>"><input type=hidden name="htmlable" value="yes">
       ...
       <tr>
        ...
        <tr>
         ...
         <tr>
          ...
          <td width="608" height="28" >
          &nbsp;<input type="text" name="addtime" size="18"
          class="smallinput" maxlength="100" value="<%=now()%>"><input type=hidden name="htmlable" value="yes"></td>
         </tr>
      </table>
      </td>
    </tr>
