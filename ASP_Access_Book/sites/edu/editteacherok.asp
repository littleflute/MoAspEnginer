...
photourl = server.htmlencode(trim(request("photourl")))
...
sql = "select count(teacherid) from teacher where loginname='"&loginname&"' and teacherid<>"&id
...
response.write "<script>alert('修改成功');window.location.href='editteacher.asp?id="&id&"';</script>"
%>