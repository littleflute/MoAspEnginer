...
<div align="center">
  <table cellpadding=0 cellspacing=0 border=0 width=760 bgcolor="#3399FF"  bordercolor="#111111">
    <tr>
      <td>
        <div align="center">
          <center>
        <table cellpadding=3 cellspacing=0 border=0 width="311" bgcolor="<%=MainCColor%>"  bordercolor="#3399FF" height="229">
          <tr align="center"> 
            <td width="305" bgcolor="#3399FF" height="68">　</td>
          </tr>
          <tr align="center"> 
            <td width="305" bgcolor="#FFCC99" height="25">
            <span style="font-size: 9pt">错误信息</span></td>
          </tr>
          <tr> 
            <td width="305" bgcolor="#FFFFFF" height="28">
            <span style="font-size: 9pt">产生错误的可能原因：<br><%=errmsg%></span></td>
          </tr>
          <tr align="center">
            <td width="305" bgcolor="#FFFFFF" height="12">
<p align="center"><a href="javascript:history.go(-1)" class="ArticleList">
<span style="font-size: 9pt">&lt;&lt; 
            返回上一页</span></a></p>
            </td>
          </tr>  
          <tr align="center">
            <td width="305" bgcolor="#3399FF" height="75">
　</td>
          </tr>  
        </table>
          </center>
