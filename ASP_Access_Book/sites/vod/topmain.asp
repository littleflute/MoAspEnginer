...
<div align="center">
  <center>
    <table width="751" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse">
      <tr>
        <td height="2" valign="top"><img src="images/top.jpg" width="750" ></td>
      </tr>
      <tr>
        <td height="1" bgcolor="#999966"> 
          <div align="center">
            <center>
...
%>
                  ...
                  <td width="68.2" height="23" onMouseOver="this.bgColor='#3399ff';" onMouseOut="this.bgColor='##999966';" bgcolor="#999966" align="center"><%else%>
                      <font color="#004C90"> </font>
                  <td width="68.2" height="23" onMouseOver="this.bgColor='#3399ff';" onMouseOut="this.bgColor='##999966';" bgcolor="#999966" align="center"  ><%end if%>
                      <font color="#004C90"> </font>
